    ...
    return (
        <main>
            <section className="relative mt-20 px-10">
                <h2 className="text-orange-700 text-center text-2xl pb-2 font-semibold">Which Apartment suits your need?</h2>
				<p className="text-lg text-center md:w-[420px] md:mx-auto lg:w-[460px]">
                    Entering a <strong>number of bedrooms</strong> required, all the apartments that meet your criteria will be displayed or an appropriate message if no such apartments are available.
                </p>
                <form
                ...
                <p className="w-auto sm:w-80 bg-orange-700 text-white text-center text-xl mx-auto p-4 pt-3 mb-6 rounded-md">There are <strong>{numOfApartFound()}</strong> apartments to rent with {numOfBedroomsSearch()} bedrooms</p>
